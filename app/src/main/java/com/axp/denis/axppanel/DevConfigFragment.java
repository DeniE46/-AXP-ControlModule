...
public class DevConfigFragment extends Fragment implements View.OnClickListener{

    Button batteryProgress, batteryPercentage, launchThemes;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dev_config_fragment, container, false);
        ...
        launchThemes = view.findViewById(R.id.open_themes);
        ...
        launchThemes.setOnClickListener(this);
